########################################################################################################################################
#     File name : BankClass                                                                                                             #
#     Author :  Mutungi Lynette Kicoonco                                                                                                #
#                                                                                                                                       #
#########################################################################################################################################



import pickle #serialises data strucures and objects
import os #enables python acces computer commands
...
class _customer(_bank):
    ...
    def general_inquiry(self):
          print("Hello %s, you are welcome to %s",(self.customerId, self.banklocation))
